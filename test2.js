...
describe('Google Search Test', function () { 
    ...
    const productNamesElements = await driver.findElements(By.className('Sauce Labs Backpack'));
    const productNames = [];
    ...
    assert.deepStrictEqual(productNames, sortedNames, 'Produk belum terurut A ke Z');
